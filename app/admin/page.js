                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:space-x-4">
                        <div className="relative flex-1 sm:flex-none">
                            ...
                            <input
                                ...
                                className="w-full sm:w-auto pl-10 pr-4 py-2 text-sm border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                            />
                        </div>
                        <motion.button
